    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Inserte numero de 1 a 3 para elejir procesador ");
            procesador = int.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese un numero de 1 a 3 para elejir memoria");
            memoria = int.Parse(Console.ReadLine());
            Console.WriteLine("Ampliar disco.... (1) SI  ó (2) NO");
            ...
            Console.WriteLine("El precio del computador es de "+ precio);
        }
    }
}
